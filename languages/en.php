...
return [
    ...
    'preset_desc'               => 'Checks/unchecks checkboxes according to the selected preset. Changes take effect only after saving settings.',
    'preset_choose'             => 'Choose',
    'preset_none'               => 'None (turn off all)',
    ...
    'admin_menu_order_desc'     => 'Drag and drop items to reorder. Click the eye icon to hide an item from the sidebar menu. Save to apply changes.',
    ...
    'pagespeed_section_title'           => 'PageSpeed Optimizations',
    'defer_js_label'                    => 'Defer JavaScript',
    'defer_js_desc'                     => 'Adds the <code>defer</code> attribute to all frontend scripts – the browser downloads them in parallel and executes after HTML parsing. Reduces Total Blocking Time (TBT).',
    'defer_js_exclude_label'            => 'Exclude from defer (handles)',
    'defer_js_exclude_desc'             => 'Scripts that should not be deferred – one handle per line (e.g. <code>jquery-core</code>). Scripts with async/defer are automatically skipped.',
    'delay_js_label'                    => 'Delay JavaScript',
    'delay_js_desc'                     => 'Delays loading of non-essential scripts (analytics, chat widgets, social feeds) until user interaction or timeout. Significantly improves PageSpeed.',
    'delay_js_keywords_label'           => 'Delay keywords',
    'delay_js_keywords_desc'            => 'Scripts matching these keywords will be delayed. One keyword per line. Matches against handle, src URL, and the full tag.',
    'delay_js_timeout_label'            => 'Timeout (seconds)',
    'delay_js_timeout_desc'             => 'If the user doesn\'t interact with the page, delayed scripts load after this time. Default: 5 seconds.',
    'async_css_label'                   => 'Async CSS',
    'async_css_desc'                    => 'Converts CSS to non-render-blocking loading via <code>rel="preload"</code>. Significantly improves FCP and LCP – CSS downloads in the background and is applied after loading.',
    'async_css_exclude_label'           => 'Exclude from async CSS (handles)',
    'async_css_exclude_desc'            => 'CSS handles that should remain render-blocking – one per line. GeneratePress styles are excluded by default (prevents FOUC).',
    'hero_preload_url_label'            => 'Preload Hero Image (URL)',
    'hero_preload_url_desc'             => 'URL of the hero image on the homepage to preload via <code>&lt;link rel="preload"&gt;</code>. Improves LCP. Only active on the front page.',
